export class Pathfinder {
  ...
  astar(graph: Graph, start: any, end: any, options?: any) {
    graph.cleanDirty();
    options = options || {};
...
export class Graph {
  ...
  constructor(astar: any, gridIn: any, options?: any) {
    this.options = options || {};
    this.nodes = [];
    if (options) this.diagonal = options.diagonal;
...
export class GridNode {
  ...
  getCost(fromNeighbor: GridNode): any {
